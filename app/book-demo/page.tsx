                ...
                <div style={{ width: "100%", maxWidth: "600px" }}>
                    ...
                    >
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                                <label style={{ fontSize: "14px", fontWeight: 700, color: "var(--text-primary)" }}>Title<span style={{ color: "#CC5500" }}>*</span></label>
                                <input required type="text" name="Title" style={{ padding: "12px 16px", borderRadius: "6px", border: "1px solid var(--border)", background: "var(--surface-1)", fontSize: "16px", color: "var(--text-primary)" }} />
                            </div>
                        </div>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                                <label style={{ fontSize: "14px", fontWeight: 700, color: "var(--text-primary)" }}>Project / Portfolio Size</label>
                                <input type="text" name="Size" placeholder="$50M+" style={{ padding: "12px 16px", borderRadius: "6px", border: "1px solid var(--border)", background: "var(--surface-1)", fontSize: "16px", color: "var(--text-primary)" }} />
                            </div>
                        </div>
